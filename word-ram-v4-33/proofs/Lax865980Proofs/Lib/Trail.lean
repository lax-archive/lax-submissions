...
namespace Lax865980Proofs.Reasoning.Lib
...
imports and creates nothing named under `Lax865980Proofs` in a consumer
package. -/
...
def layout : Lax865980Proofs.Compile.Layout := ⟨["t", "tb", "x", "y", "r"], ["tr", "mk"], 4⟩

/-- The machine program. -/
def prog : Lax865980.Ram.Program :=
  Lax865980Proofs.Compile.compileProgram layout (demoWatched "tr" "t" "tb" "mk" "x" "y" "r")
...
theorem demoWatched_ok :
    Lax865980Proofs.Compile.Com.Ok layout (demoWatched "tr" "t" "tb" "mk" "x" "y" "r") := by
  simp [demoWatched, record, unwind, unwindBody, Ind.mark, Ind.test, layout,
    Lax865980Proofs.Compile.Com.Ok, Lax865980Proofs.Compile.Cond.Ok, Lax865980Proofs.Compile.condExpr,
    Lax865980Proofs.Compile.Expr.Ok]
...
def demoRun : Option (List ℕ × ℕ) := runOut 16 4000 prog (Lax865980.Ram.initState []) 0
...
end Lax865980Proofs.Reasoning.Lib
