...
def layout : Lax865980Proofs.Compile.Layout := ⟨["j", "m", "w", "u"], ["off", "tgt"], 4⟩

/-- The machine program. -/
def prog : Lax865980.Ram.Program :=
  Lax865980Proofs.Compile.compileProgram layout (demoWatched "off" "tgt" "j" "m" "w" "u")
...
theorem demoWatched_ok :
    Lax865980Proofs.Compile.Com.Ok layout (demoWatched "off" "tgt" "j" "m" "w" "u") := by
