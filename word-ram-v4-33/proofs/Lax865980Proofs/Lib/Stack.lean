...
def layout : Lax865980Proofs.Compile.Layout := ⟨["t", "x", "y", "r"], ["st"], 2⟩

/-- The machine program. -/
def prog : Lax865980.Ram.Program :=
  Lax865980Proofs.Compile.compileProgram layout (demoWatched "st" "t" "x" "y" "r")
...
theorem demoWatched_ok :
    Lax865980Proofs.Compile.Com.Ok layout (demoWatched "st" "t" "x" "y" "r") := by
  simp [demoWatched, push, pop, peek, layout, Lax865980Proofs.Compile.Com.Ok,
