...
declarations named under `Lax808846Proofs`, which the archive's namespace
...
theorem _root_.Lax808846Proofs.Imp.BigStep.vars_eq {c : Com} {σ σ' : Env} {k : ℕ}
...
theorem _root_.Lax808846Proofs.Imp.BigStep.arrs_eq {c : Com} {σ σ' : Env} {k : ℕ}
...
alone. -/
theorem _root_.Lax808846Proofs.Imp.BigStep.inp_eq {c : Com} {σ σ' : Env} {k : ℕ}
...
theorem _root_.Lax808846Proofs.Imp.notMem_wvars_ne {c : Com} {y z : String}
