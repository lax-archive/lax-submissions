...
Most relevant to our paper, for every graph $G$, $\tww(G) \leqslant 3 \cdot 2^{\tw(G)-1}$~\cite{Jacob22}, where % lax begin Lax228581.Treewidth
...
% lax begin Lax228581.ExponentialSeparation
...
% lax begin Lax228581Proofs.Main.exists_treewidth_le_and_two_pow_lt_twinWidth
