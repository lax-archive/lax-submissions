...
namespace Lax271696Proofs.Courcelle

open Lax808846.Ram Lax808846.RamComputes Lax271696.GraphEncoding Lax271696.Mso Lax271696.CliqueExpr
open Lax808846Proofs.Imp Lax808846Proofs.Compile Lax808846Proofs.Reasoning Lax808846Proofs.Transfer
open Lax271696Proofs.TreeFold Lax271696Proofs.MsoTypes Lax271696Proofs.MsoTable
open Lax271696Proofs.CC (readLoop readLoop_run)
open Lax271696.InstanceEncoding (EncodesModelCheckingInstance)
...
/--
---
conclusion: Lax271696.Courcelle.exists_linearTime_program_modelChecking
---
...
their own notes — the logic in `Lax271696.Mso`, `k`-expressions in
`Lax271696.CliqueExpr`, the input format in `Lax271696.InstanceEncoding` — and what is
...
`Lax808846.Ram` has one, and under a unit-cost measure a linear-time claim
...
de Bruijn positions, so a reader checking `Lax271696.Mso` against a textbook
