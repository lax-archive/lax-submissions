...
namespace Lax199508Proofs.NowhereDenseDensity
...
/--
---
conclusion: Lax199508.NowhereDenseDensity.hasSubpolynomialDensity_of_nowhereDense
---
...
`Lax199508Proofs.DensityOfShallowMinors.nd_subpolynomial_density`.
-/
theorem hasSubpolynomialDensity_of_nowhereDense (C : GraphClass)
    (h : NowhereDense C) : HasSubpolynomialDensity C := by
  classical
  intro r ε hε
  obtain ⟨N, hN⟩ := Lax199508Proofs.DensityOfShallowMinors.nd_subpolynomial_density
...
end Lax199508Proofs.NowhereDenseDensity
