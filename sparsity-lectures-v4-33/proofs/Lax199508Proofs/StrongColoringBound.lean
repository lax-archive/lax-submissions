...
namespace Lax199508Proofs.StrongColoringBound
...
/--
---
conclusion: Lax199508.StrongColoringBound.scol_le_of_adm
---
...
per-order version is `Lax199508Proofs.ScolByAdm.scol_le_one_add_adm_sub_one_pow`.
-/
theorem scol_le_of_adm {n : ℕ} (G : SimpleGraph (Fin n)) (r : ℕ) :
  ...
  letI := orderOfPerm π
  have h1 : Lax199508Proofs.OrderedParameters.adm G r ≤ adm G r :=
    catalog_adm_le G r (adm G r) hπ
  have h2 : scol G r ≤ Lax199508Proofs.OrderedParameters.scol G r :=
    scol_le_catalog (orderOfPerm π) G r
  have h3 : Lax199508Proofs.OrderedParameters.scol G r ≤
      1 + (Lax199508Proofs.OrderedParameters.adm G r - 1) ^ r :=
    Lax199508Proofs.ScolByAdm.scol_le_one_add_adm_sub_one_pow G r
  have h4 : (Lax199508Proofs.OrderedParameters.adm G r - 1) ^ r ≤ (adm G r - 1) ^ r :=
    Nat.pow_le_pow_left (Nat.sub_le_sub_right h1 1) r
  omega

end Lax199508Proofs.StrongColoringBound
