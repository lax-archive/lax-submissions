...
namespace Lax199508Proofs.NowhereDenseWcol

open scoped SimpleGraph
open Lax199508.GraphClasses Lax199508.NowhereDenseClasses Lax199508.ColoringNumbers
open Lax199508.Admissibility Lax199508.ShallowMinorDensity
open Lax199508Proofs.MinorBridge Lax199508Proofs.OrderBridge

/--
---
conclusion: Lax199508.NowhereDenseWcol.hasSubpolynomialWcol_of_nowhereDense
assumptions:
  - Lax199508.NowhereDenseDensity.hasSubpolynomialDensity_of_nowhereDense
  - Lax199508.AdmissibilityBound.adm_le_of_hasTopologicalDensityAtMost
  - Lax199508.StrongColoringBound.scol_le_of_adm
  - Lax199508.WeakColoringBound.wcol_le_of_scol
---
...
theorem hasSubpolynomialWcol_of_nowhereDense (C : GraphClass)
  ...
  obtain ⟨c₁, hc₁⟩ := Lax199508.NowhereDenseDensity.hasSubpolynomialDensity_of_nowhereDense
  ...
  · have hm1 : (1 : ℝ) ≤ (m : ℝ) := by exact_mod_cast hmpos
    ...
    have hadm : adm H r ≤ 1 + 6 * (r + 1) * d ^ 3 :=
      le_trans (adm_le_adm_succ H r)
        (Lax199508.AdmissibilityBound.adm_le_of_hasTopologicalDensityAtMost H r d
          (hasTopologicalDensityAtMost_of_hasDensityAtMost hdens))
    have hscol := Lax199508.StrongColoringBound.scol_le_of_adm H r
    have hwcolstep := Lax199508.WeakColoringBound.wcol_le_of_scol H r
...
end Lax199508Proofs.NowhereDenseWcol
