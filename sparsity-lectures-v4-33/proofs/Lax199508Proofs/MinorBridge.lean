...
namespace Lax199508Proofs.MinorBridge

open scoped SimpleGraph
open Lax199508.NowhereDenseClasses Lax199508.ShallowMinorDensity
open Lax199508.ShallowTopologicalMinors
...
theorem hasShallowMinor_of_isShallowMinor {V W : Type}
    ...
    (h : Lax199508Proofs.ShallowMinors.IsShallowMinor H G r) :
...
theorem isShallowMinor_of_hasShallowMinor {V W : Type}
    ...
    Lax199508Proofs.ShallowMinors.IsShallowMinor H G r := by
  classical
  obtain ⟨M⟩ := h
...
submitted class. -/
def closure (C : Lax199508.GraphClasses.GraphClass) : Lax199508.GraphClasses.GraphClass :=
...
def subgraphClosure (C : Lax199508.GraphClasses.GraphClass) :
    Lax199508Proofs.ShallowMinors.GraphClass :=
  fun {_} _ _ H => ∃ (n : ℕ) (G : SimpleGraph (Fin n)), C n G ∧ H ⊑ G

/-- Every member of a class is a member of its subgraph closure. -/
theorem subgraphClosure_self {n : ℕ} {C : Lax199508.GraphClasses.GraphClass}
...
private theorem isShallowMinor_of_copy {U W V : Type}
    ...
    (f : SimpleGraph.Copy H G) (h : Lax199508Proofs.ShallowMinors.IsShallowMinor K H r) :
    Lax199508Proofs.ShallowMinors.IsShallowMinor K G r := by
  obtain ⟨M⟩ := h
  refine ⟨{
...
theorem nowhereDense_closure {C : Lax199508.GraphClasses.GraphClass}
...
theorem isNowhereDense_subgraphClosure {C : Lax199508.GraphClasses.GraphClass}
    (h : NowhereDense C) :
    Lax199508Proofs.ShallowMinors.IsNowhereDense (subgraphClosure C) := by
  intro r
  obtain ⟨t, ht⟩ := h r
...
end Lax199508Proofs.MinorBridge
