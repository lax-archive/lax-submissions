...
FINISH.md was executed on Jan's machine the same day. All 18 patches applied
cleanly to the book's `main` at 4ec9235, every package built locally at
v4.33.0 (~25 min), and the chain was resubmitted bottom-up with no retry
and no fix beyond the series: lax-251941, lax-765601 @ 6980467;
lax-132576 @ 0257c90; lax-916827 @ 2649bf2; lax-314295, lax-709149 @ baffefb;
lax-194892 @ e563124; lax-157538 @ ab3f15c — all eight drafts at v4.33.0.
The book's `main` is at ce87f39 with the updated CAMPAIGN table. The umbrella's
old `paper · web-oracle` warning did not recur. Registration (bottom-up)
remains Jan's manual step. The eight root-level mirror folders stay on the
branch `claude/transducers-latest-epoch-port-jiv5kl` and were not landed
here; the book is the home.
