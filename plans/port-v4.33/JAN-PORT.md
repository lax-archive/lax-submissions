...
| 3 | registration per D4 | after 2 | main | DONE 2026-09-15: lax-710763 REGISTERED (lax-5 now shows as superseded); lax-242665 REGISTERED @ f7c9272; lax-808846 REGISTERED @ 9394e53 (Jan, `supersedes: lax-67`); then on Jan's "register all my submissions": lax-271696 @ 956e1cf and lax-62 @ 9d06d27 registered in parallel (both depend only on lax-808846), lax-3 @ c474df4 after them. Every Jan-authored record on main is now registered. Note: the three registered RAM dependents pin Lax808846 at 5a2645e, one manifest-only commit behind the registered 9394e53 (Lean content identical); `lax build` rejects that pin locally until main repins |
