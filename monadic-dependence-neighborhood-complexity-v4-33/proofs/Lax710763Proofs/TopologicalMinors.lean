...
submission; the only consumer here is `Lax710763Proofs.NowhereDenseBridge`.
-/

namespace Lax710763Proofs.TopologicalMinors
...
end Lax710763Proofs.TopologicalMinors
