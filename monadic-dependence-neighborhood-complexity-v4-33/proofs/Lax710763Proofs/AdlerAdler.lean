...
`Lax710763.AdlerAdler.monadicallyDependent_of_nowhereDense`.
...
namespace Lax710763Proofs.AdlerAdler

open FirstOrder Lax710763.Transductions Lax710763.GraphClasses Lax199508.GraphClasses
open Lax710763Proofs.LocalTypes Lax710763Proofs.EFAgreement Lax710763Proofs.BallSwap
...
/--
---
conclusion: Lax710763.AdlerAdler.monadicallyDependent_of_nowhereDense
assumptions:
...
and `Lax710763Proofs.QuasiWideness` only reshapes the conclusion from `Set`
...
theorem monadicallyDependent_of_nowhereDense
    ...
    Lax710763.MonadicDependence.MonadicallyDependent C := by
  classical
  intro hT
  obtain ⟨T, hprod⟩ := hT
  ...
  obtain ⟨N, s, huqw⟩ := Lax710763Proofs.QuasiWideness.uqw_of_nowhereDense C h
    (3 ^ (q + 2))
  ...
  have hps : Lax710763.GraphTransductions.structureClass allGraphs (d + 2 ^ d)
...
end Lax710763Proofs.AdlerAdler
