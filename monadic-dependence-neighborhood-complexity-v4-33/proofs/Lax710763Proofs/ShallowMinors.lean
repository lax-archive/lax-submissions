...
`Lax710763Proofs.NowhereDenseBridge` and `Lax710763Proofs.Corollary6a` are stated in.
-/

namespace Lax710763Proofs.ShallowMinors
...
end Lax710763Proofs.ShallowMinors
