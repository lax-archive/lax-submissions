...
namespace Lax710763Proofs.CrossingTransduction
...
theorem transduces_bipartiteGraphs {C : GraphClass} {ℓ : ℕ} (hℓ : 1 ≤ ℓ)
    ...
    Lax710763.GraphTransductions.Transduces C bipartiteGraphs := by
  classical
...
theorem bipartiteGraphs_transduces_allGraphs :
    Lax710763.GraphTransductions.Transduces bipartiteGraphs allGraphs := by
  classical
