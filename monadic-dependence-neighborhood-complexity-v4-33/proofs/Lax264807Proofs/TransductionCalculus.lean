...
namespace Lax264807Proofs.TransductionCalculus

open FirstOrder Lax264807.Transductions
...
theorem Transduces.trans [L'.IsRelational] [L''.IsRelational]
  ...
  obtain ⟨T₁, hT₁⟩ := h₁
  obtain ⟨T₂, hT₂⟩ := h₂
  refine ⟨Lax264807Proofs.TransductionCalculus.Transduction.comp T₁ T₂,
    fun p P hP => ?_⟩
...
end Lax264807Proofs.TransductionCalculus
