...
`Lax264807Proofs.NowhereDenseBridge` and `Lax264807Proofs.Corollary6a` are stated in.
-/

namespace Lax264807Proofs.ShallowMinors
...
end Lax264807Proofs.ShallowMinors
