...
submission; the only consumer here is `Lax264807Proofs.NowhereDenseBridge`.
-/

namespace Lax264807Proofs.TopologicalMinors
...
end Lax264807Proofs.TopologicalMinors
