...
order-type bipartite Ramsey theorem from `Lax264807Proofs.TupleRamsey`.
-/

namespace Lax264807Proofs.SubdividedBicliqueRamsey
...
end Lax264807Proofs.SubdividedBicliqueRamsey
